...
type Server struct {
	...
	IsLeader string `protobuf:"bytes,3,opt,name=is_leader,json=isLeader,proto3" json:"is_leader,omitempty"`
}
...
func (x *Server) GetIsLeader() string {
	if x != nil {
		return x.IsLeader
	}
	return ""
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x08, 0x69, 0x73, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x32, 0xd6, 0x02, 0x0a, 0x03,
	...
	0x6f, 0x6d, 0x2f, 0x57, 0x68, 0x69, 0x74, 0x6e, 0x65, 0x79, 0x4c, 0x61, 0x6d, 0x70, 0x6b, 0x69,
