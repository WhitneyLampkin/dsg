...
import (
	...
	"github.com/whitneylampkin/proglog/internal/auth"
...
// Defines list of test cases
// Runs a subtest for each case
...
// Helper function that sets up test cases
func setupTest(t *testing.T, fn func(*Config)) (
	...
	// Setup and start the Telemetry Exporter
...
func testProduceConsume(t *testing.T, client, _ api.LogClient, cfg *Config) {
	...
	// Checking that the value produced is the value returned
	require.NoError(t, err)
